        ...
        <AbsolutePanel style="topMenuBar">
          <menuBar>
            <menu display="Widgets" id="widgetMenu">
              ...
              <menuItem description="Screen to test CheckBox functionality" display="CheckBox" enabled="false" icon="nothing" key="checkbox"/>
              <menuItem description="Screen to test EditBox functionality" display="EditBox" enabled="false" icon="nothing" key="editbox"/>
            </menu>
            <menu display="Help">
