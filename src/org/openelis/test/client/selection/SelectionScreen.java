package org.openelis.test.client.selection;
...
import org.openelis.gwt.widget.DropSelection;
...
public class SelectionScreen extends Screen {
	...
	public SelectionScreen() {
		super((ScreenDefInt)GWT.create(SelectionDef.class));
	...
	public void initialize() {
		...
		test = (DropSelection)def.getWidget("test");
