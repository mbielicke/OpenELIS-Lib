...
public class UCheckBox extends FocusPanel implements ScreenWidgetInt<String>, HasBlurHandlers, HasFocusHandlers, HasValueChangeHandlers<String>, HasValue<String>,  HasExceptions {
     ...
     * @param mode
     */
    public UCheckBox(CheckMode mode) {
        init();
        setMode(mode);
    }
...
//******** Implementation of ScreenWidgetInt ***********************    
    ...
    /**
     * Returns a QueryData object of type string only if checkbox is set to 
     * "Y" or "N"
     */
...
// ******* Implementation of HasValue<String> ******
    ...
    /**
     * Sets the value of this widget.  Will fire a ValueChangeEvent if 
     * fireEvents passed as true and the new value is not equals to old value
     */
