...
public class Tree extends FocusPanel implements ScreenWidgetInt, Queryable,
     ...
     * @return
     */
    public ArrayList<Column> getNodeDefinition(String type) {
     ...
     * @param index
     */
    public void selectNodeAt(int index, GwtEvent event) {
     ...
     * @param index
     */
    public void selectNodeAt(Node node, GwtEvent event) {
        if(isDisplayed(node))
     ...
     * @param index
     */
    protected void unselectNodeAt(int index,GwtEvent event) {
