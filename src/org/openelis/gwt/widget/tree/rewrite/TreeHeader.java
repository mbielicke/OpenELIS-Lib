...
import org.openelis.gwt.widget.table.HeaderMenu;
...
public class TreeHeader extends FlexTable implements TreeHeaderInt, TableListener, MouseListener{
    ...
    public TreeHeader(TreeWidget controller) {
        this.controller = controller;
        //this.columns = controller.columns;
        setCellSpacing(0);
        int j = 0;
        for(TreeColumn header : controller.headers) {
            Label headerLabel = new Label(header.getHeader());
