...
public class TreeHeaderMenuBar extends MenuPanel implements MouseListener, PopupListener, ClickListener{
                    ...
                    public void execute() {
                        ...
                        for (int j = 0; j < controller.view.table.getRowCount(); j++) {
                            for (int i = 0; i < controller.headers.size(); i++) {
                               ...
                               // ((Widget)controller.view.table.getWidget(j,i)).setWidth(controller.headers.get(i).getCurrentWidth());
    ...
    public void performCommand(Enum action, Object obj) {
        ...
        if(action == MenuItem.Action.OPENING) {         
            ...
            final TreeColumn col = (TreeColumn)controller.controller.headers.get(index);
    ...
    public void onClick(Widget sender) {
        if(sender instanceof MenuItem) {
            ...
            TreeColumn col = (TreeColumn)controller.headers.get(0);
            ...
            if((filter.obj).toString().equals("All")){
