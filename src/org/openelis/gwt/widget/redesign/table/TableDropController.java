...
public final class TableDropController extends SimpleDropController implements
    ...
    public void onPreviewDrop(DragContext context) throws VetoDragException {
        ...
        event = BeforeDropEvent.fire(this, (DragItem)context.draggable, table.getModel()
                                                                             .get(targetRow));
    ...
    public void onMove(DragContext context) {
        ...
        if (table.getRowCount() > 0) {
            ...
            event = DropEnterEvent.fire(this, (DragItem)context.draggable, table.getModel()
                                                                                .get(targetRow),
                                        dropPos);
    ...
    private boolean scroll() {
        ...
        if (targetRow <= 0 && targetModelIndex > 0)
            scrollRows = -1;
                 ...
                 targetModelIndex < table.getRowCount() - 1)
            scrollRows = 1;
