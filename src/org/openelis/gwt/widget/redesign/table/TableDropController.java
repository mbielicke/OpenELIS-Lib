...
*/
public final class TableDropController extends SimpleDropController implements HasBeforeDropHandlers<DragItem>, HasDropHandlers<DragItem>,HasDropEnterHandlers<DragItem> {
	...
	public TableDropController(Table tbl) {
	    ...
	    /*
	     * Set up the positioner widget used to let the user know where the drop will occur 
	     */
